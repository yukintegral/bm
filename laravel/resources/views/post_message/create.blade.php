                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New post_message</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/post_message/store" class="form-horizontal">
                                    {{ csrf_field() }}

    										<div class="form-group">
                                        <label for="post_message" class="col-md-4 control-label">post_message: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="post_message" type="text" id="post_message" value="{{old('post_message')}}">
                                        </div>
                                    </div>
										<div class="form-group">
