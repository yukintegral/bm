...
use Validate;
use DB;
use App\Post_message;
    
    //=======================================================================
    class Post_messagesController extends Controller
    {
        /**
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $post_message = Post_message::where("id","LIKE","%$keyword%")->orWhere("post_message", "LIKE", "%$keyword%")->orWhere("post_id", "LIKE", "%$keyword%")->orWhere("user_id", "LIKE", "%$keyword%")->orWhere("file", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $post_message = Post_message::paginate($perPage);              
            }          
        ...
        public function store(Request $request)
        {
            ...
            Post_message::create($requestData);
        ...
        {
            $post_message = Post_message::findOrFail($id);
