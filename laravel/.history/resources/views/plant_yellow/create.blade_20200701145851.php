                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New plant_yello</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/plant_yello/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="plant_yellow" type="text" id="plant_yellow" value="{{old('plant_yellow')}}">
                                        </div>
                                    </div>
