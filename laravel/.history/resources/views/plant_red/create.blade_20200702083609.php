                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New plant_red</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/plant_red/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" name="plant_red" type="text" id="plant_red" value="{{old('plant_red')}}">
                                        </div>
                                    </div>
