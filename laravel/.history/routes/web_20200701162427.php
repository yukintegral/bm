...
//=======================================================================
//index
Route::get("plant_white/", "Plant_white@index");
//create
Route::get("plant_white/create", "Plant_white@create");
//show
Route::get("plant_white/{id}", "Plant_white@show");
//store
Route::post("plant_white/store", "Plant_white@store");
//edit
Route::get("plant_white/{id}/edit", "Plant_white@edit");
//update
Route::put("plant_white/{id}", "Plant_white@update");
//destroy
Route::delete("plant_white/{id}", "Plant_white@destroy");
//=======================================================================
