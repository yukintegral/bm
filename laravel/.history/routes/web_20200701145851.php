...
//=======================================================================
//index
Route::get("plant_re/", "PlantRedController@index");
//create
Route::get("plant_re/create", "PlantRedController@create");
//show
Route::get("plant_re/{id}", "PlantRedController@show");
//store
Route::post("plant_re/store", "PlantRedController@store");
//edit
Route::get("plant_re/{id}/edit", "PlantRedController@edit");
//update
Route::put("plant_re/{id}", "PlantRedController@update");
//destroy
Route::delete("plant_re/{id}", "PlantRedController@destroy");
//=======================================================================
