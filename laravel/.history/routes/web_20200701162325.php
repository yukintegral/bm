...
//=======================================================================
//index
Route::get("plant_blue/", "PlantBlueController@index");
//create
Route::get("plant_blue/create", "PlantBlueController@create");
//show
Route::get("plant_blue/{id}", "PlantBlueController@show");
//store
Route::post("plant_blue/store", "PlantBlueController@store");
//edit
Route::get("plant_blue/{id}/edit", "PlantBlueController@edit");
//update
Route::put("plant_blue/{id}", "PlantBlueController@update");
//destroy
Route::delete("plant_blue/{id}", "PlantBlueController@destroy");
//=======================================================================
