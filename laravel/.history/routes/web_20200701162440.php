...
//=======================================================================
//index
Route::get("plant_pink/", "PlantPinkController@index");
//create
Route::get("plant_pink/create", "PlantPinkController@create");
//show
Route::get("plant_pink/{id}", "PlantPinkController@show");
//store
Route::post("plant_pink/store", "PlantPinkController@store");
//edit
Route::get("plant_pink/{id}/edit", "PlantPinkController@edit");
//update
Route::put("plant_pink/{id}", "PlantPinkController@update");
//destroy
Route::delete("plant_pink/{id}", "PlantPinkController@destroy");
//=======================================================================
