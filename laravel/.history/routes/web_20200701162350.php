...
//=======================================================================
//index
Route::get("plant_yellow/", "PlantYellowController@index");
//create
Route::get("plant_yellow/create", "PlantYellowController@create");
//show
Route::get("plant_yellow/{id}", "PlantYellowController@show");
//store
Route::post("plant_yellow/store", "PlantYellowController@store");
//edit
Route::get("plant_yellow/{id}/edit", "PlantYellowController@edit");
//update
Route::put("plant_yellow/{id}", "PlantYellowController@update");
//destroy
Route::delete("plant_yellow/{id}", "PlantYellowController@destroy");
//=======================================================================
