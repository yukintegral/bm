...
//=======================================================================
//index
Route::get("plant_pink/", "Plant_pink@index");
//create
Route::get("plant_pink/create", "Plant_pink@create");
//show
Route::get("plant_pink/{id}", "Plant_pink@show");
//store
Route::post("plant_pink/store", "Plant_pink@store");
//edit
Route::get("plant_pink/{id}/edit", "Plant_pink@edit");
//update
Route::put("plant_pink/{id}", "Plant_pink@update");
//destroy
Route::delete("plant_pink/{id}", "Plant_pink@destroy");
//=======================================================================
