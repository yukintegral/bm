...
//=======================================================================
//index
Route::get("plant_pink/", "Plant_pinks@index");
//create
Route::get("plant_pink/create", "Plant_pinks@create");
//show
Route::get("plant_pink/{id}", "Plant_pinks@show");
//store
Route::post("plant_pink/store", "Plant_pinks@store");
//edit
Route::get("plant_pink/{id}/edit", "Plant_pinks@edit");
//update
Route::put("plant_pink/{id}", "Plant_pinks@update");
//destroy
Route::delete("plant_pink/{id}", "Plant_pinks@destroy");
//=======================================================================
