...
//=======================================================================
//index
Route::get("plant_white/", "PlantWhiteController@index");
//create
Route::get("plant_white/create", "PlantWhiteController@create");
//show
Route::get("plant_white/{id}", "PlantWhiteController@show");
//store
Route::post("plant_white/store", "PlantWhiteController@store");
//edit
Route::get("plant_white/{id}/edit", "PlantWhiteController@edit");
//update
Route::put("plant_white/{id}", "PlantWhiteController@update");
//destroy
Route::delete("plant_white/{id}", "PlantWhiteController@destroy");
//=======================================================================
