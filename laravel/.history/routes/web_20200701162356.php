...
//=======================================================================
//index
Route::get("plant_yellow/", "Plant_@index");
//create
Route::get("plant_yellow/create", "Plant_@create");
//show
Route::get("plant_yellow/{id}", "Plant_@show");
//store
Route::post("plant_yellow/store", "Plant_@store");
//edit
Route::get("plant_yellow/{id}/edit", "Plant_@edit");
//update
Route::put("plant_yellow/{id}", "Plant_@update");
//destroy
Route::delete("plant_yellow/{id}", "Plant_@destroy");
//=======================================================================
