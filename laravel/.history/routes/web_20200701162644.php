...
//=======================================================================
//index
Route::get("post_status/", "PostStatusesController@index");
//create
Route::get("post_status/create", "PostStatusesController@create");
//show
Route::get("post_status/{id}", "PostStatusesController@show");
//store
Route::post("post_status/store", "PostStatusesController@store");
//edit
Route::get("post_status/{id}/edit", "PostStatusesController@edit");
//update
Route::put("post_status/{id}", "PostStatusesController@update");
//destroy
Route::delete("post_status/{id}", "PostStatusesController@destroy");
//=======================================================================
