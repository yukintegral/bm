...
use App\TransactionMessage;
    ...
    class TransactionMessagesController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $transaction_message = TransactionMessage::where("id","LIKE","%$keyword%")->orWhere("transaction_message", "LIKE", "%$keyword%")->orWhere("transaction_id", "LIKE", "%$keyword%")->orWhere("sender_id", "LIKE", "%$keyword%")->orWhere("receiver_id", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $transaction_message = TransactionMessage::paginate($perPage);              
            }          
        ...
        public function store(Request $request)
        {
            ...
            TransactionMessage::create($requestData);
        ...
        {
            $transaction_message = TransactionMessage::findOrFail($id);
