...
use App\Post;
    ...
    class PostStatusesController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $post_statuse = Post::where("id","LIKE","%$keyword%")->orWhere("posts_status", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $post_statuse = Post::paginate($perPage);              
            }          
        ...
        {
            $post_statuse = Post::findOrFail($id);
