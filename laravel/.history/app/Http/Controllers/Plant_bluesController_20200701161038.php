...
use App\Plant_blue;
    ...
    class PlantBlusController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $plant_blu = Plant_blue::where("id","LIKE","%$keyword%")->orWhere("user_id", "LIKE", "%$keyword%")->orWhere("plant_blue", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
        ...
        {
            $plant_blu = Plant_blue::findOrFail($id);
