...
use App\UserLike;
    ...
    class UserLikesController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $user_like = UserLike::where("id","LIKE","%$keyword%")->orWhere("liking_user_id", "LIKE", "%$keyword%")->orWhere("liked_user_id", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $user_like = UserLike::paginate($perPage);              
            }          
        ...
        {
            $user_like = UserLike::findOrFail($id);
