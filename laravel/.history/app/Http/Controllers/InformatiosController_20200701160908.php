...
use App\Information;
    ...
    class InformatiosController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $informatio = Informatio::where("id","LIKE","%$keyword%")->orWhere("content", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $informatio = Informatio::paginate($perPage);              
            }          
        ...
        {
            $informatio = Informatio::findOrFail($id);
