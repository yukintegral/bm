...
use App\Plant_white;
    ...
    class PlantWhitsController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $plant_whit = Plant_white::where("id","LIKE","%$keyword%")->orWhere("user_id", "LIKE", "%$keyword%")->orWhere("plant_white", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $plant_whit = Plant_white::paginate($perPage);              
            }          
        ...
        {
            $plant_whit = Plant_white::findOrFail($id);
