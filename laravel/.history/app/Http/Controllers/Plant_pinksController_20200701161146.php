...
use App\PlantPin;
    ...
    class PlantPinsController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $plant_pin = PlantPin::where("id","LIKE","%$keyword%")->orWhere("user_id", "LIKE", "%$keyword%")->orWhere("plant_pink", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $plant_pin = PlantPin::paginate($perPage);              
            }          
        ...
        {
            $plant_pin = PlantPin::findOrFail($id);
