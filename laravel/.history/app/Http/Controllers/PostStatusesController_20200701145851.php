...
use App\PostStatuse;
    ...
    class PostStatusesController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $post_statuse = PostStatuse::where("id","LIKE","%$keyword%")->orWhere("posts_status", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $post_statuse = PostStatuse::paginate($perPage);              
            }          
        ...
        public function store(Request $request)
        {
            ...
            PostStatuse::create($requestData);
        ...
        {
            $post_statuse = PostStatuse::findOrFail($id);
