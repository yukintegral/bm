                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Create New plant_pink</div>
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/plant_pink/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="plant_pink" type="text" id="plant_pink" value="{{old('plant_pink')}}">
                                        </div>
                                    </div>
