...
use App\Post_file;
    ...
    class Post_filesController extends Controller
    {
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $post_file = Post_file::where("id","LIKE","%$keyword%")->orWhere("post_id", "LIKE", "%$keyword%")->orWhere("file", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $post_file = Post_file::paginate($perPage);              
            }          
        ...
        {
            $post_file = Post_file::findOrFail($id);
