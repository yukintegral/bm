...
//=======================================================================
//index
Route::get("information/", "InformationsController@index");
//create
Route::get("information/create", "InformationsController@create");
//show
Route::get("information/{id}", "InformationsController@show");
//store
Route::post("information/store", "InformationsController@store");
//edit
Route::get("information/{id}/edit", "InformationsController@edit");
//update
Route::put("information/{id}", "InformationsController@update");
//destroy
Route::delete("information/{id}", "InformationsController@destroy");
//=======================================================================
