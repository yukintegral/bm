                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <form method="POST" action="/transaction/{{ $transaction->id }}" class="form-horizontal">
                                        {{ csrf_field() }}
                                        {{ method_field("PUT") }}
										...
										<div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" required="required" name="post_id" type="text" id="post_id" value="{{$transaction->post_id}}">
                                            </div>
                                        </div>
										<div class="form-group">
                                            <label for="user_id" class="col-md-4 control-label">user_id: </label>
                                            <div class="col-md-6">
                                                <input class="form-control" required="required" name="user_id" type="text" id="user_id" value="{{$transaction->user_id}}">
                                            </div>
                                        </div>
