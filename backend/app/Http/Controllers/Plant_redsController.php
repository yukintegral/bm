...
use App\Plant_red;
    ...
    //=======================================================================
    class Plant_redsController extends Controller
    {
        /**
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $plant_red = Plant_red::where("id","LIKE","%$keyword%")->orWhere("user_id", "LIKE", "%$keyword%")->orWhere("plant_red_status", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
        ...
        public function store(Request $request)
        {
            $this->validate($request, [
				...
				"plant_red_status" => "nullable|integer", //integer('plant_red_status')->nullable()
