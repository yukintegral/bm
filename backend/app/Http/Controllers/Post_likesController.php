...
use App\Post_like;
    ...
    //=======================================================================
    class Post_likesController extends Controller
    {
        /**
        ...
        public function index(Request $request)
        {
            ...
            if (!empty($keyword)) {
                $post_like = Post_like::where("id","LIKE","%$keyword%")->orWhere("user_id", "LIKE", "%$keyword%")->orWhere("post_id", "LIKE", "%$keyword%")->paginate($perPage);
            } else {
                    $post_like = Post_like::paginate($perPage);              
            }          
        ...
        {
            $post_like = Post_like::findOrFail($id);
